...
func TestGetEndpointURL(t *testing.T) {
	testCases := []struct {
		...
		{"https://storage.example.com:6781", false, "", errInvalidArgument("Endpoint scheme does not match secure option."), false},
		{"http://127.0.0.1:9000", true, "", errInvalidArgument("Endpoint scheme does not match secure option."), false},
