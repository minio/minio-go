...
// isValidReplicationHeader returns true if header is one of valid internal headers
func isValidReplicationHeader(headerKey string) bool {
	return supportedReplicationHeaders[strings.ToLower(headerKey)]
}
